...
ROOT=Path(__file__).resolve().parents[1];QA=ROOT/'.qa/year4-maths'
...
def main():
 lessons=json.loads((QA/'lessons.json').read_text(encoding='utf-8'));lookup={f"4-{l['week']}-{l['day']}":l for l in lessons}
